...
def generate_sample(m, l, u, sample_num, folder_path):
    ...
    for iter in range(sample_num):
        ...
        Rs = np.log(1+unit_us.dot(assortments.T))
...
if __name__ == '__main__':
    ...
    # m = 10  # segment number
    # generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m10n10_log_correct_1e_3/')
    # Test with m=20 and n=10
    m = 20  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m20n10_log_correct_1e_3/')
    
    # # Test with m=30 and n=10
    m = 30  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m30n10_log_correct_1e_3/')
