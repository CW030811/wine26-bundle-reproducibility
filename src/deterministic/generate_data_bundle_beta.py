...
def generate_sample(m, l, u, sample_num, folder_path, beta_a, beta_b):
    '''
    ...
    for iter in range(sample_num):
        ...
        costs = costs*0.2
        unit_us = np.random.beta(a=beta_a, b=beta_b, size=(m, n))
...
if __name__ == '__main__':
    ...
    # Generate beta(5, 5) samples.
    m = 20  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m20n10_beta_5_5_correct_1e_3/', 5, 5)

    m = 30  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m30n10_beta_5_5_correct_1e_3/', 5, 5)

    # Generate beta(0.5, 0.5) samples.
    m = 20  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m20n10_beta_half_half_correct_1e_3/', 0.5, 0.5)

    m = 30  # segment number
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_OOD/test_m30n10_beta_half_half_correct_1e_3/', 0.5, 0.5)
