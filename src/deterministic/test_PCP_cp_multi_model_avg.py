...
def main():
    ...
    parser.add_argument("--test_subdirs", type=str, default="data/deterministic/test_m10n10_1e_3;data/deterministic/test_m20n10_1e_3;data/deterministic/test_m30n10_1e_3", help="测试数据子目录（多个用分号分隔）")
