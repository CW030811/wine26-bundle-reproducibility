...
from test_FCP_f33 import EdgeScoringGCN, process_data, revenue_ratio
...
def main():
    ...
    parser.add_argument("--test_subdirs", type=str, default="data/ood/test_m10n10_f0.33_correct_1e_3/;", 
            ...
            try:
                ...
                for nl in layers:
                    ...
                    for sd, mdl, path in models_by_layer[nl]:
                        try:
                            start_inf = time.time()
                            pred_assort = run_one_model(mdl, dat, n, m_segments)
                            gcn_time = time.time() - start_inf
