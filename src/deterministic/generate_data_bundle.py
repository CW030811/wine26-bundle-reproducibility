...
def solve_bundle_MILP(n, m, B, assortments, costs, Rs, Rbar, Ns):
    ...
    Z = model.addVars(m, B, vtype=GRB.CONTINUOUS,
...
if __name__ == '__main__':
    ...
    # generate_sample(m, 5, 10, 1000, dir_path + '/dataset/train/')
    # generate_sample(m, 5, 10, 500, dir_path + '/dataset/test/')
    # generate_sample(m, 14, 15,  1, dir_path + '/dataset/test-large-u-bigger/')
    # generate_sample(m, 10, 11, 5000, dir_path + '/dataset/train/')
    # generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_m10n10_1e_3/')
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_m10n10_correct_1e_3/')
    
    
    
    
    m = 20
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_m20n10_correct_1e_3/')
    
    m = 30
    generate_sample(m, 10, 11, 100, dir_path + '/dataset/test_m30n10_correct_1e_3/')
