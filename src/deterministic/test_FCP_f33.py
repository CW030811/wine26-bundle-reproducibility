...
def revenue_ratio(n, m, unit_cs, ship_cs, unit_us, Ns, opt_rev, pred_assort, time_limit=600):
    ...
    Rs_predicted = np.cbrt(unit_us.dot(predicted_assortments.T))  # shape: (m, len(predicted_bundles))
...
def main(use_web_gcn=False, web_results_path=None):
    ...
    test_data_path = os.path.join(dir_path, "data", "ood", "test_m10n10_f0.33_correct_1e_3")
